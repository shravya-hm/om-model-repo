package Theoretical_nanofiltration
 ...
 record membrane_properties
  ...
  parameter Modelica.SIunits.Length l_m[10] = {0.26, 0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 1, 1.5, 2} "Capillary membrane length";
...
// convert from pa to bar - Q from l/h to m3/s, flow is considered to bequally distributed through the m capillaries in the n fibres
